...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-panel/gnome-panel-2.32.1-r2.ebuild,v 1.15 2012/02/10 02:43:51 patrick Exp $
...
src_prepare() {
	...
	# Fuzzy time patch
	epatch "${FILESDIR}/${PN}-2.30.2-1ubuntu3-fuzzy-clock.diff"
