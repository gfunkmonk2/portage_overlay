...
# $Header: /var/cvsroot/gentoo-x86/sys-block/gparted/gparted-0.12.0.ebuild,v 1.2 2012/03/15 21:30:58 ssuominen Exp $
...
src_prepare() {
	...
	sed -i -e 's#Categories=GNOME;System;Filesystem;#Categories=GNOME;System;Filesystem;Settings;#' gparted.desktop.in.in || die
	sed -i -e 's:GParted Partition Editor:Partition Editor:' gparted.desktop.in.in || die
